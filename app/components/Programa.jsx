    ...
    <div className='mb-8'>
      ...
      <div className='mb-8'>
        <ol className='list-decimal pl-4'>
          ...
          <li className='mb-4'>Invocación a Dios por la profesora:{/*pendiente*/}</li>
          ...
          <p>
            ...
            Sexto B: Angel
            <br /><br />
            Sexto C: Katerine Addaly Icú Curruchich y Xeila Rosmeri Calí Chicol
          </p>
          <br />
          <li className='mb-4'> Canto del Himno Nacional a cargo de la seccion &quot;A&quot;.</li>
          <li className='mb-4'> Jura a la Bandera a cargo de la seccion &quot;C&quot;.</li>
          ...
          <li className='mb-4'> Palabras de bienvenida a cargo de la seccion B.</li>
          ...
          <li className='mb-4'> Palabras de despedida a cargo de la seccion &quot;C&quot;.</li>
          ...
          <li className='mb-4'> Palabras de agradecimiento por la directiva.</li>
        </ol>
      </div>
      </div>
      ...
      <div className='text-center mt-8'>
        ...
        <p className='text-xl'>
           Profa. Erika Chicol <br />
           Prof. Antonio Juchuña
        </p>
      </div>
    </section>
  );
